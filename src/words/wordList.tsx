...
const wordList: Word[] = [
    ...
    { id: 151, date: '2021-08-20', korean: '왔습니다', japanese: '来ました、帰りました'},
    { id: 151, date: '2021-08-20', korean: '갔습니다', japanese: '行きました、帰りました'},
    { id: 151, date: '2021-08-20', korean: '뒤', japanese: '後ろ、今後'},
    { id: 151, date: '2021-08-20', korean: '수업', japanese: '授業'},
    { id: 151, date: '2021-08-20', korean: '이후', japanese: '以降、今後'},
    { id: 151, date: '2021-08-20', korean: '초급', japanese: '初級'},
    { id: 151, date: '2021-08-20', korean: '중급', japanese: '中級'},
    { id: 151, date: '2021-08-20', korean: '일찍', japanese: '早めに'},
    { id: 151, date: '2021-08-20', korean: '상급', japanese: '上級'},
    { id: 151, date: '2021-08-20', korean: '취소', japanese: '取り消し'},
    { id: 151, date: '2021-08-21', korean: '음식점', japanese: '飲食店'},
    { id: 151, date: '2021-08-21', korean: '어떤', japanese: 'どんな'},
    { id: 151, date: '2021-08-21', korean: '무슨', japanese: '何の'},
    { id: 151, date: '2021-08-21', korean: '갈까요?', japanese: '行きましょうか'},
    { id: 151, date: '2021-08-21', korean: '즐겁다', japanese: '楽しい'},
    { id: 151, date: '2021-08-21', korean: '재미없다', japanese: '面白くない'},
    { id: 151, date: '2021-08-21', korean: '식당', japanese: '食堂'},
    { id: 151, date: '2021-08-21', korean: '한식당, 한식집', japanese: '韓国料理屋'},
    { id: 151, date: '2021-08-21', korean: '중식당, 중식집', japanese: '中華料理屋'},
    { id: 151, date: '2021-08-21', korean: '일식당, 일식집', japanese: '日本料理屋'},
    { id: 151, date: '2021-08-21', korean: '양식당, 양식집, 양식점', japanese: '洋食屋'},
    { id: 151, date: '2021-08-22', korean: '이야기하는', japanese: '話す、言う、語る・・・'},
    { id: 151, date: '2021-08-22', korean: '이야기해서', japanese: '話して、言って、語って・・・'},
    { id: 151, date: '2021-08-22', korean: '읽는', japanese: '読む・・・'},
    { id: 151, date: '2021-08-22', korean: '읽어서', japanese: '読んで・・・'},
    { id: 151, date: '2021-08-22', korean: '재미있는', japanese: '面白い・・・'},
    { id: 151, date: '2021-08-22', korean: '재미있어서', japanese: '面白くて・・・'},
    { id: 151, date: '2021-08-22', korean: '본', japanese: '見た・・・'},
    { id: 151, date: '2021-08-22', korean: '봐서', japanese: '見て・・・'},
    { id: 151, date: '2021-08-22', korean: '마시는', japanese: '飲む・・・'},
    { id: 151, date: '2021-08-22', korean: '마셔서', japanese: '飲んで・・・'},
    { id: 151, date: '2021-08-22', korean: '받는', japanese: '貰う、受ける・・・'},
    { id: 151, date: '2021-08-22', korean: '받아서', japanese: '貰って、受けて・・・'},
    { id: 151, date: '2021-08-22', korean: '~마다', japanese: '～毎'},
    { id: 151, date: '2021-08-22', korean: '받다', japanese: '貰う、受ける'},
    { id: 151, date: '2021-08-22', korean: '주다', japanese: 'あげる、くれる'},
    { id: 151, date: '2021-08-22', korean: '알다', japanese: '分かる、知る'},
    { id: 151, date: '2021-08-22', korean: '아는 사람', japanese: '知り合い'},
];
